...
<?php 
 ...
 ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Mark Attendence</h1>
          <p>Please enter details to Mark the Attendence</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item"><a href="#">Mark Attendence</a></li>
        </ul>
      </div>
               ...
               <?php 
                ...
                ?>                   
                     <form action="" method="POST" >
                      ...
                      <div class="form-group">
                        <input type="submit" name="submit" value="Mark Attendence" class="btn btn-primary" >
    ...
    <?php
      if (isset($_POST['submit'])) {
       ...
       if ($std=='null'  || empty($atdate) || $meal =='null' ) {
            ...
            $query = "INSERT INTO attendence (std_id , meal_id ,atdate ,mcreated_by ,created_at) VALUES('{$std}' , '{$meal}' , '{$atdate}'  , '{$author}', '{$date}')";
